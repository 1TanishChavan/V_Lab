...
const judge0ApiClient = axios_1.default.create({
...
const b64Encode = (str) => buffer_1.Buffer.from(str).toString('base64');
const b64Decode = (str) => buffer_1.Buffer.from(str, 'base64').toString('utf-8');
...
function getRunResult(token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield judge0ApiClient.get(`/submissions/${token}`, {
                params: { base64_encoded: 'true', fields: 'status,stdout,stderr,time,memory' }
            });
            const data = response.data;
            if (data.stdout)
                data.stdout = b64Decode(data.stdout);
            if (data.stderr)
                data.stderr = b64Decode(data.stderr);
            return data;
        }
        catch (error) {
...
function runCode(runData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield judge0ApiClient.post('/submissions', {
...
function createBatchSubmissions(code, language, testCases) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield judge0ApiClient.post('/submissions/batch', { submissions }, { params: judge0PostParams });
...
function pollBatchResults(tokens) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (attempts < MAX_POLL_ATTEMPTS) {
            ...
            const response = yield judge0ApiClient.get('/submissions/batch', {
                params: {
                    tokens: batchTokens,
                    base64_encoded: 'true',
...
function submitCode(submissionData) {
    return __awaiter(this, void 0, void 0, function* () {
        const [existingSubmission] = yield db_1.db
            .select({ submission_id: schema_1.submissions.submission_id })
            .from(schema_1.submissions)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.submissions.practical_id, submissionData.practicalId), (0, drizzle_orm_1.eq)(schema_1.submissions.student_id, submissionData.studentId)))
            .limit(1);
        if (existingSubmission) {
            return updateSubmissionCode(Object.assign(Object.assign({}, submissionData), { submissionId: existingSubmission.submission_id }));
        }
...
function updateSubmissionCode(submissionData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield redis_1.default.del(`submission:${submissionData.submissionId}`);
        }
        catch (error) {
