...
import { getBatches, createBatch, updateBatch, deleteBatch, getBatchesByDepartmentAndSemester, getBatchesList } from './../controllers/batchController';
...
router.get('/list', authMiddleware, getBatchesList);
