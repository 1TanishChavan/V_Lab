  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {practicals.map((practical) => (
        <div key={practical.practical_id} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
          <h3 className="text-lg font-semibold">{practical.practical_name}</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">{practical.description}</p>
          <div className="mt-4">
